            ...
            <div>
                ...
                <div className="flex justify-between items-start gap-3 mb-2.5">
                    ...
                    <button 
                        ...
                        className="p-1.5 -mr-1 -mt-1 rounded-lg text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-colors flex-shrink-0 cursor-pointer"
                    >
                        {job.saved ? (
                ...
                <div className="flex flex-wrap gap-2 mb-3.5">
                    <Pill icon={<Building className="w-3.5 h-3.5" />}>
                        {job.company}
                    </Pill>
                    ...
                    {job.source && (
                        <Pill icon={<Globe className="w-3.5 h-3.5" />}>
                            {job.source}
                        </Pill>
                    )}
                </div>
